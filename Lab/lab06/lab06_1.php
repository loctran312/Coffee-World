	...
	<fieldset>
		...
		<form action="lab06_1.php" method="post" enctype="multipart/form-data">
			<table align="center">
                ...
                <tr>
                    <td>Thông tin</td>
                    <td><textarea name="thong_tin" cols="30" rows="10"></textarea></td>
                </tr>
				<tr>
    ...
    ?>
        <div class="info">
            ...
            if ($err != "") echo $err;
                ...
                echo "Mật khẩu đã mã hóa MHA1:" . sha1(md5($password1)) . "<br>";

                echo "Mật khẩu đã mã hóa SHA1:" . sha1($password1) . "<br>";
