...
*/
function BCC($n = 6, $colorHead = "red", $color1 = "yellow", $color2 = "blue")
{
	?>
	<table bgcolor="<?php echo $colorHead;?>">
	<tr><td colspan="3">Bảng cửu chương <?php echo $n;?></td></tr>
	<?php
		for($i=1; $i<=10; $i++)
		{
			?>
			<tr bgcolor="<?php if($i%2==0) echo $color2; else echo $color1?>"><td><?php echo $n;?></td>
				<td><?php echo $i;?></td>
				<td><?php echo $n*$i;?></td>
			</tr>
			<?php
